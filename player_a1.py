...
class PlayerA:
    def __init__(self):
        ...
        self.server_hitpoints_sub = rospy.Subscriber("/serverA_hitpoints", Int32MultiArray, self.serverHitpointsCallback, queue_size=1)
        self.playerA_targetnames_pub = rospy.Publisher('/player_a_targets', String, queue_size=10)
    ...
    def serverHitpointsCallback(self, msg):
        ...
        if(msg.data != self.hitpoints_all):
            ...
            hitpoints = msg.data[:3]
            print("Player A's Monster Hitpoints:")
            self.printHitpoints(hitpoints, monsterANames)

            opponent_hitpoints = msg.data[3:6]
            print("Player B's Monster Hitpoints:")
            self.printHitpoints(opponent_hitpoints, monsterBNames)
    ...
    def sendMoves(self, targeted_monster_names):
         ...
         self.playerA_targetnames_pub.publish(names_msg)
